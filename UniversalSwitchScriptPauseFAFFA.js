...
function Apple(){
        ...
        CenterButton.addEventListener('mousedown', onn);
        CenterButton.addEventListener('touchstart', onn);
        CenterButton.addEventListener('mouseup', offf);
        CenterButton.addEventListener('touchend', offf);
...
function onn(){
    var xhr = new XMLHttpRequest();
    xhr.open('GET', '/onn', true);
    xhr.send();
}

function offf(){
    var xhr = new XMLHttpRequest();
    xhr.open('GET', '/offf', true);
    xhr.send();
}

...
function OpenModeSettings(){
    ...
    function SetET() {
     ...
     if ((stateString === "Zweifach-Taster") || (stateString === "Zweifach-Schalter")) {
      ...
      if(     ((X === 1) && (statee === "CLR100")) )           {
        TouchAreaLeft.style.display = "block";
      TouchAreaRight.style.display = "block";
     }
     else if(     ((X === 1) && (statee === "CLR010")) )           {
        TouchAreaLeft.style.display = "block";
        TouchAreaRight.style.display = "block";
     }
     else if(     ((X === 1) && (statee === "CLR001")) )           {
        TouchAreaLeft.style.display = "block";
        TouchAreaRight.style.display = "block";
     }
     else if(     ((X === 1) && (statee === "CLR110")) )           {
        TouchAreaLeft.style.display = "block";
        TouchAreaRight.style.display = "block";
     }
     else if(     ((X === 1) && (statee === "CLR011")) )           {
        TouchAreaLeft.style.display = "block";
        TouchAreaRight.style.display = "block";
     }
     else if(     ((X === 1) && (statee === "CLR101")) )           {
        TouchAreaLeft.style.display = "block";
        TouchAreaRight.style.display = "block";
     }
     else if(     ((X === 1) && (statee === "CLR111")) )           {
        TouchAreaLeft.style.display = "block";
        TouchAreaRight.style.display = "block";
     }
     else{

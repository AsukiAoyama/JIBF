       ...
       Apple();
        ...
        function UpdateTouchLayoutL(state){
            ...
            function UpdateTouchLayoutR(state){
                ...
                document.querySelector('#Center-Button-Container').addEventListener('mousedown', handleButtonEvent);
                document.querySelector('#Center-Button-Container').addEventListener('mouseup', handleButtonEvent);
                document.querySelector('#Center-Button-Container').addEventListener('touchstart', handleButtonEvent);
                document.querySelector('#Center-Button-Container').addEventListener('touchend', handleButtonEvent);

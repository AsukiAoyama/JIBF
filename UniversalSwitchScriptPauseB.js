    ...
    xhr.onreadystatechange = function() {
      ...
      function UpdateTouchLayoutC(state){
       ...
       Apple();
                ...
                function Apple(){
                 ...
                 TouchAreaLeft.style.display = "block";
                    ...
                    TouchAreaRight.style.display = "none";
                      ...
                      // JavaScript to request fullscreen mode
        ...
        // Call the function to make the document body fullscreen when the page loads
        document.addEventListener('DOMContentLoaded', function() {
            requestFullScreen(document.documentElement); // Make the entire document fullscreen
        });
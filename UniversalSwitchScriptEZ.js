...
function OpenModeSettings(){
    ...
    function SetET() {
      ...
      function UpdateTouchAreaL(state){
        ...
        if (X === 2) {
            if (statee.includes("CLR010") || statee.includes("CLR011") || statee.includes("CLR110") || statee.includes("CLR111")) {
                TouchAreaLeft.style.display = "block";
            } else {
                TouchAreaLeft.style.display = "none";
            }
        
            if (statee.includes("CLR001") || statee.includes("CLR011") || statee.includes("CLR101") || statee.includes("CLR111")) {
                TouchAreaRight.style.display = "block";
            } else {
                TouchAreaRight.style.display = "none";
            }

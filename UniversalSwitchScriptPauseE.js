       ...
       Apple();
        ...
        function UpdateTouchLayoutL(state){
            ...
            function UpdateTouchLayoutR(state){
                ...
                document.querySelector('#Center-Button-Container').addEventListener('mousedown', pressButton);
                document.querySelector('#Center-Button-Container').addEventListener('mouseup', releaseButton);
                document.querySelector('#Center-Button-Container').addEventListener('touchstart', pressButton);
                document.querySelector('#Center-Button-Container').addEventListener('touchend', releaseButton);

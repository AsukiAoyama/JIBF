    ...
    function SetET() {
     ...
     if ((stateString === "Zweifach-Taster") || (stateString === "Zweifach-Schalter")) {
      ...
      setInterval(function() {
        ...
        xhr.onreadystatechange = function() {
          if (xhr.readyState == 4 && xhr.status == 200) {
            UpdateTouchAreaC(xhr.responseText);
          }
        };
      ...
      function UpdateTouchAreaC(state){
        var stateee = String(state);
      ...
      setInterval(function() {
        ...
        xhr.onreadystatechange = function() {
          if (xhr.readyState == 4 && xhr.status == 200) {
            UpdateTouchAreaR(xhr.responseText);
          }
        };
      ...
      function UpdateTouchAreaR(state){
        var stateeee = String(state);

...
function UpdateModeText(state) {
    ...
    if ((stateString === "Einfach-Taster") || (stateString === "Einfach-Schalter") || (stateString === "Kreuzschalter") || (stateString === "Notification-Schalter")) {
...
function UpdateRelay1State(state){
    ...
    if((NScounter === 1) && (N === 1)){
        alert("Der Universal-Switch wurde betätigt!");
    }  
}

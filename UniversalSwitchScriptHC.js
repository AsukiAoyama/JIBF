...
function UpdateModeText(state) {
    ...
    if ((stateString === "Einfach-Taster") || (stateString === "Einfach-Schalter") || (stateString === "Kreuzschalter")) {
     ...
     else if ((stateString === "Notification-Schalter")) {
        A.style.display = "block"; 
        B.style.display = "none"; 
        C.style.display = "none"; 
        D.style.display = "none"; 
...
function UpdateRelay1State(state){
    ...
    if((NSonCounter === 3) && (N === 1)){
        NotificationOn();
    }  

    if((NSoffCounter === 3) && (N === 1)){
        NotificationOff();
    } 
}
...
function NotificationOn(){
   ...
   NText.innerHTML = "Universal-Switch 1 ist eingeschalten!";
   var audio = new Audio('https://cdn.jsdelivr.net/gh/AsukiAoyama/JIBF@main/Sounds/Ding.mp3');
   audio.play();
}
...
function NotificationOff(){
    NotificationText.style.top = "5%";
    NText.innerHTML = "Universal-Switch 1 ist ausgeschalten!";
        var audio = new Audio('https://cdn.jsdelivr.net/gh/AsukiAoyama/JIBF@main/Sounds/Ding.mp3');
        audio.play();
